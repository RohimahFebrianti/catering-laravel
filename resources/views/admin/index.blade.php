    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/admin">
                ...
                <div class="sidebar-brand-text mx-3">Viima Catering</sup></div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="/allmenu">
                    <i class="fas fa-fw fa-book"></i>
                    <span>Data Menu</span>
                </a>
                <a class="nav-link collapsed" href="/pesanan-user">
                ...
                <a class="nav-link collapsed" href="/feedback-user">
                    <i class="fas fa-fw fa-user"></i>
                    <span>Feeback</span>
                </a>
        </ul>
            ...
            <div id="content">
                ...
                <footer class="sticky-footer bg-white">
                    <div class="container my-auto">
                        <div class="credits">
                            Mini Project 2 2023 by <a href="https://bootstrapmade.com/">Rohimah & Salma</a>
                        </div>
                    </div>
                </footer>
                <!-- End of Footer -->
